          ...
          <div class="main-container d-flex">
            ...
            <div class="content">
              <div class="dashboard-content px-3 pt-4">
                <h1 class="fs-7" style="font-weight: bold;"> Repository</h1>
                      ...
                      <table class="table" style="margin-top: 2em;">
                        ...
                        <tbody>
                          <% Connection con=null; Class.forName("com.mysql.jdbc.Driver"); con=(Connection)
                            ...
                            st=con.createStatement(); String sql="select * from sln" ; ResultSet
                            rs=st.executeQuery(sql); while(rs.next()) { String a=rs.getString(1); String
                            b=rs.getString(2); String c=rs.getString(3); String d=rs.getString(4); %>
                            <tr>
                              <td>
                                <%=a%>
                              </td>
