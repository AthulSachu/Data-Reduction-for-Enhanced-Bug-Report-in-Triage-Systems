                      ...
                      <form action="Assign" method="post">
                        <table class="my-3" borer="1">
                          ...
                          <tr style="vertical-align: top;">
                            ...
                            <td>
                              <textarea name="b2" style="width: 50em;
                                height: 150px;
                                padding: 12px 20px;
                              ...
                              <select name="b3" style="width:148px;">
                                <%!String user; String desig; %>
                                  <% Connection con=null; Class.forName("com.mysql.jdbc.Driver"); con=(Connection)
                                    ...
                                    st=con.createStatement(); String sql="select * from users" ; ResultSet
                                    r=st.executeQuery(sql); while(r.next()) { user=r.getString(2); desig=r.getString(5);
                                    %>
                                    <option value="<%=user %>">
                                      <%=user%>-<%=desig%>
                                    </option>
                          ...
                          <tr>
                            <td>Triage</td>
                            <td><select name="q" style="width: -moz-available;">
