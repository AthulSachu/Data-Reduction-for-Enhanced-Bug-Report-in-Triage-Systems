...
<body>
    ...
    <section id="home" class="hero">
        ...
        <ul>
            <li><h5>Reduce the scale and improve the quality of bug data.</h5></li>
            <li><h5>Reduce data scale on the bug dimension and the word dimension</h5></li>
        </ul>

        <button class="button1 my-3" type="button" href="mlog.jsp">
            <span class="button-text"><a href="mlog.jsp">Manager Login</a></span>
        </button>
        ...
        <form action="Dl" method='post'>
            <div class="login-form">
                ...
                <div class="input-box">
                    <input type="text" placeholder="Developer ID" name="a1" required>
                </div>
                <div class="input-box">
                ...
                <div class="reg">
                    <span class="usr">New Employee? <a href="new.jsp" style="color: gray;">Register</a></span>
                </div>
            </div>
        </form>
    </section>
        ...
        <div class="container-fluid">  
            <div class="row">
              ...
              <div class="col-sm-6 image-block">
                ...
                <span class="widt"> <img src="images/ghhh.JPG" alt="" width="700px" height="440px"> <span class="tx_widt">
                    <br>
            </span></span>
              </div>
            </div>
